...
def register():
    ...
    page_title       = 'Register - Alpha design coded in Flask | AppSeed App Generator'
    page_description = 'HTML5 Up Alpha design coded in Flask Microframework, registration page.'
...
def login():
    ...
    page_title       = 'Login - Alpha design coded in Flask | AppSeed App Generator'
    page_description = 'HTML5 Up Alpha design coded in Flask Microframework, login page.'
